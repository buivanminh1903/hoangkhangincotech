            ...
            <div class="hk_breadcrumb_right">
                <ul class="hk_menu">
                    ...
                    <li  class="contact-us" style="color: #028bfe; margin-left: 5px;"><i
                            class="fa-solid fa-angle-right"></i>&nbsp;&nbsp;Contact Us</li>
                </ul>
            </div>
        </div>
        <!--End breadcrumb-->
			...
			<form>
				<div class="row" style="margin-left: 0; margin-right: 0;">
					<div class="col-lg-6 col-md-6 col-sm-12 form-name">
						<input id="your-name"   name="name" type="text" class="form-control"  placeholder="Your Name" required="">
					</div>

					<div class="col-lg-6 col-md-6 col-sm-12 form-name">
						<input id="your-name"  name="name" type="text" class="form-control"  placeholder="Your Email" required="">
					</div>

					<div class="col-lg-6 col-md-6 col-sm-12 form-name">
						<input id="your-phone" name="name" type="text" class="form-control" id="input-register" placeholder="Phone" required="">
					</div>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 form-meseage">
						<textarea  id="meseage-register" class="form-control" name="subject" placeholder="Your Messeage: "></textarea>
					</div>

					<div class="col-lg-12 col-md-12 col-sm-12 button-send">
						<button id="button-sendmessage" type="form-control"  class="btn btn-primary" >SEND MESSEAGE</button>
					</div>
