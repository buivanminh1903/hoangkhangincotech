                    ...
                    <div class="detail-connten">
                        ...
                        <div>
                            <span style="color: gray;"><i style=" color: rgb(2, 139, 254);"
                                                          class="fa-solid fa-calendar-check"></i> 09 DEC,2021 / By<a
                                    class="author"
                            ...
                            <!-- Trích lời  -->
                                <div class="vline-new">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <b class="text-new-content" style="font-size: 20px;"> <i>Aouses or months
                                                    settle
                                            ...
                                            <p class="text-new-content" style="  color: rgb(144, 143, 143);">- John
                                                DOE</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <ul class="check-ul">
                                <li class="fa-solid fa-check" style="color: #55ACEE;"></li>
                                <u
                                    class="check">Compellingly facilitate impactful</u></br>
                                <li class="fa-solid fa-check" style="color: #55ACEE;"></li>
                                <u class="check">Uniquely
