...
@section('content')
    ...
    <div class="container" style="width: 1170px;">
        ...
        <div class="service-title-open">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam ac eros a tellus posuere gravida. Vestibulum
            eget sapien eleifend, imperdiet orci nec, venenatis libero. Sed sit amet turpis nec ipsum condimentum
            sagittis non vel massa. Ut dapibus fermentum
            nibh, eget placerat urna viverra vitae. Class aptent taciti sociosqu ad litora torquent per conubia nostra,
            per inceptos himenaeos. Mauris nec nisl aliquam, porttitor leo ac, pharetra metus. Sed ultrices blandit
            ipsum vitae faucibus. Nunc
            tristique convallis tristique.
        </div>
        <div class="service-content">
            Bibendum nunc vel velit pharetra, eu bibendum sapien tincidunt. Etiam laoreet ultricies dolor in pharetra.
            Sed gravida eros sed velit bibendum, laoreet lobortis ligula tincidunt. Integer gravida auctor hendrerit.
        </div>
                    ...
                    <div class="service-main-box">
                        ...
                        <div class="service-main-box5">
                            <ul>
                                ...
                                <li class="service_text_dark"><img src="image/iconcheckmo.png" alt="">Configuration
                                    Management
                                </li>
                                <li class="service_text_dark"><img src="image/iconcheckmo.png" alt="">App intergition
                                </li>
                                <li class="service_text_dark"><img src="image/iconcheckmo.png" alt="">App Intergition
                                </li>
                            </ul>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-6">
                            <div class="content">
                                ...
                                <p>Conveniment predomiate sticky aligmi than lơw risk high methods of emp brand supeinos
                                    techno</p>
                            </div>
