...
@section('content')
    <nav aria-label="breadcrumb" class="fw-bold py-3">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item" aria-current="page"><a href="/backend/post">Post</a></li>
        ...
        <div class="row">
            <div class="backend__card p-3">
                <form>
                    ...
                    <div class=" row mb-3">
                        <label for="exampleFormControlSelect1" class="col-sm-2 col-form-label">Category id</label>
                        <div class="col-sm-10">
