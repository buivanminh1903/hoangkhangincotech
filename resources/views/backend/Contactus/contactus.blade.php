    ...
    <div class="container mb-3">
        <div class="row">
            <div class="backend__card p-3">
                ...
                <a class="btn btn-outline-info m-2" href="/admin/contactus/add"><i class="bx bx-plus-circle me-1"></i>
                    Thêm liên hệ
                </a>
                <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <a class="btn btn-info btn-sm"
                                       href="{{'/admin/contactus/edit/' . $item->id}}">
                                       <i class="bx bx-edit-alt me-1"></i> Sửa</a>

                                    <form method="POST" action="{{url ('/admin/contactus/delete/' .$item->id)}}"
